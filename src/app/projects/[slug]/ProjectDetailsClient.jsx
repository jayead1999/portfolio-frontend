...
export default function ProjectDetailsClient({ slug, initialProject }) {
  ...
  return (
    <>
          ...
          <div className="container mx-auto px-6 md:px-12">
            ...
            >
              {project.gallery_images.map((galleryImg, i) => (
                <div 
                  key={i} 
                  onClick={() => setSelectedGalleryImage(galleryImg)}
      ...
      {selectedGalleryImage && (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-background/95 backdrop-blur-xl p-4 md:p-12">
          <button 
      ...
      {project.video && (
        <section className="py-24 border-t border-white/5 bg-black">
          <div className="container mx-auto px-6 md:px-12 text-center">
             ...
             <div className="aspect-video w-full max-w-5xl mx-auto rounded-3xl overflow-hidden border border-white/10">
